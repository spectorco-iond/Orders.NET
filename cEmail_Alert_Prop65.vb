Public Class cEmail_Alert_Prop65
...
#Region "Private maintenance procedures ###################################"
        ...
        Private Sub Load(ByVal pintID As Integer)
            ...
            strSql =
            "SELECT * " &
            "FROM   OEI_Email_Alert_Prop65 WITH (Nolock) " &
            "WHERE  ID = " & pintID & " "
        ...
        Private Sub LoadLine(ByRef pdrRow As DataRow)
            ...
            m_Item_Guid = pdrRow.Item("Item_Guid").ToString
    ...
    Private Sub SaveLine(ByRef pdrRow As DataRow)
        Try
            ...
            pdrRow.Item("Item_Guid") = m_Item_Guid
...
#Region "Public maintenance procedures ####################################"
    ...
    Public Sub Delete()
            ...
            strSql =
            "DELETE FROM OEI_Email_Alert_Prop65 " &
            "WHERE  ID = " & m_ID & " AND " &
